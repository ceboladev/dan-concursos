    ...
    feed.innerHTML = lista.map((q, index) => {
        ...
        return `
            <div class="card-questao" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 20px; border-radius: 8px; background: #fff;">
                ...
                <button class="btn-verificar" onclick="verificarResposta(${q.id}, ${q.correta})" style="margin-top: 15px; cursor: pointer; color: white; background-color: #2c3e50; border-radius: 9px; padding: 10px;">
                    Verificar Resposta
                </button>
